...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    opoFinanceAuthUserSubject.add(
      OpoFinanceAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<OpoFinanceAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  OpoFinanceAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = OpoFinanceAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    opoFinanceAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
