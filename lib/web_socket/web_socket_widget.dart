        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Builder(
                builder: (context) {
                  final webSocketList = FFAppState().webSocketData.toList();
                  return ListView.builder(
                    padding: EdgeInsets.zero,
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    itemCount: webSocketList.length,
                    itemBuilder: (context, webSocketListIndex) {
